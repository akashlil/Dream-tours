...
const ServiceBookDetals = () => {
  ...
  const onSubmit = (data) => {
    ...
    if (userOldBookList) {
      ...
      fetch(`https://salty-cove-54306.herokuapp.com/booktours`, {
        method: "POST",
        headers: {
  ...
  return (
    <div className="">
      <div className="banner-s-s">
        <img className="service-banner" src={myOrder?.serviceimg} alt="" />
            ...
            <div className="col-md-8 col-12">
              ...
              <div>
                ...
                <p>
                  ...
                  sit amet blandit bibendum. Nulla facilisi. Suspendisse
                  potenti. Nullam a ipsum iaculis, imperdiet mauris eu,
                  malesuada dui. Vestibulum iaculis congue enim, ac sodales
                  felis rhoncus vitae. Quisque molestie mi mi, vestibulum
